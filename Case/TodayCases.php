...
<body>
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1><i class="fas fa-gavel"></i> Today's Cases</h1>
            <div>
        ...
        <table id="todayCasesTable" class="table table-bordered table-hover text-white" style="width: 100%">
            <thead>
                <tr>
                    <th>File No</th>
                    <th>Case Type</th>
            ...
            <tbody>
                ...
                // SQL query to fetch cases where hearing_date is today
                $sql = "SELECT * FROM cases WHERE hearing_date = '$today' AND status = 'Running'";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='8'>No cases scheduled for today</td></tr>";
                }
                ?>
            </tbody>
        </table>
