          ...
          <form id="caseForm" action="./index.php" method="POST" enctype="multipart/form-data">
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="fileNo" name="fileNo" placeholder="Enter File No">
              </div>
              <div class="col-md-6">
                <label for="caseNo" class="form-label">Case No*</label>
                <input type="text" class="form-control" id="caseNo" name="caseNo" placeholder="Enter Case No/Year" required>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="fixedFor" name="fixedFor" placeholder="Enter date fixed for what">
              </div>
              <div class="col-md-6">
                <label for="firstParty" class="form-label">1st Party</label>
                <input type="text" class="form-control" id="firstParty" name="firstParty" placeholder="Enter First party">
              </div>
              <div class="col-md-6">
                <label for="secondParty" class="form-label">2nd Party</label>
                <input type="text" class="form-control" id="secondParty" name="secondParty" placeholder="Enter Second party">
              </div>
              <div class="col-md-6">
                <label for="mobileNo" class="form-label">Mobile No</label>
                <input type="tel" class="form-control" id="mobileNo" name="mobileNo" placeholder="Enter Client mobile no" pattern="[0-9]{10}">
              </div>
              <div class="col-md-6">
                <label for="appointedBy" class="form-label">Appointed By</label>
                <input type="text" class="form-control" id="appointedBy" name="appointedBy" placeholder="Enter which party appointed you">
              </div>
              <div class="col-md-6">
                <label for="lawSection" class="form-label">Law & Section</label>
                <input type="text" class="form-control" id="lawSection" name="lawSection" placeholder="Enter Law & Section">
              </div>
              <div class="col-12">
                <label for="comments" class="form-label">Comments/Others</label>
                <textarea class="form-control" id="comments" name="comments" placeholder="Enter more about this case" rows="3"></textarea>
              </div>
              <div class="col-md-6">
